...
RESULTS_ROOT = BASE_DIR / "results" / "rl_experiment_results"

EXPERIMENT_PRESETS = {
    "fixed120": {
        "standard_dir": RESULTS_ROOT
        / "rl_standard_results"
        / "rl_results_final_10000_hpc_120",
        "tuning_dir": RESULTS_ROOT
        / "rl_tuning_results"
    ...
    "joint100": {
        ...
        "tuning_dir": RESULTS_ROOT / "rl_tuning_results" / "rl_tuning_hpc_100",
    },
    "joint60": {
        "standard_dir": RESULTS_ROOT
        / "rl_standard_results"
        / "rl_results_final_10000_hpc_standard",
        "tuning_dir": RESULTS_ROOT / "rl_tuning_results" / "rl_tuning_hpc_60",
    },
    "gamma_high": {
        "standard_dir": RESULTS_ROOT
        / "rl_standard_results"
...
OUTPUT_DIR = BASE_DIR / "results" / "statistical_analysis_results"
