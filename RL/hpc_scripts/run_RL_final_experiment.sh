...
RESULTS_DIR="$RL_DIR/results/rl_experiment_results/rl_standard_results/rl_results_final_10000_hpc"
LOG_DIR="$RL_DIR/logs"
...
cd "$RL_DIR"
export PYTHONPATH="$RL_DIR/RL_simulation:$RL_DIR/experiments:${PYTHONPATH:-}"
