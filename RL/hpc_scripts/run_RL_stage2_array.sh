...
if [ ! -f "$STAGE1_DIR/stage1_trials.csv" ]; then
    ...
    echo "Run Stage 1 first: sbatch hpc_scripts/run_RL_stage1_BO.sh"
    exit 1
fi
...
COMMAND=(
    "$PYTHON_BIN"
    "hyperparameter_tuning/RL_agent/stage_2/run_stage2_candidate_from_stage1_rank.py"
...
echo "python hyperparameter_tuning/RL_agent/stage_2/combine_rl_stage2_results.py --stage2-dir $STAGE2_DIR --expected-n-top $N_TOP"
echo "=============================================="
