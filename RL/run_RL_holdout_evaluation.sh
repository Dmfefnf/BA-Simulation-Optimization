...
OUTPUT_DIR="results/rl_holdout_results/holdout_100_seeds"
OVERWRITE=false
...
echo "python rl_holdout_evaluation.py --combine-only --output-dir $OUTPUT_DIR --overwrite"
echo "=============================================="
