...
import run_stage2_candidate_from_stage1_rank_fixed120

print("Import check passed: ax, numpy, pandas, salabim, rl_tuning_common_fixed120, run_stage2_candidate_from_stage1_rank_fixed120")
PY

COMMAND=(
    "$PYTHON_BIN"
    "run_stage2_candidate_from_stage1_rank_fixed120.py"
