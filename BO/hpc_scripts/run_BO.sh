...
#SBATCH --output=/cfs/earth/scratch/freyfab2/BA/BA-Simulation-Optimization/BO/results/bo_%A_%a.out
#SBATCH --error=/cfs/earth/scratch/freyfab2/BA/BA-Simulation-Optimization/BO/results/bo_%A_%a.err
...
OBJECTIVE_WEIGHT_COMPLETED=0.35 # Default: 1.0
OBJECTIVE_WEIGHT_LATE_TOTAL=0.8 # Default: 3.0
OBJECTIVE_WEIGHT_STATION_CAPACITY=3.0 # Default: 0.8
OBJECTIVE_WEIGHT_WORKER_CAPACITY=1.0 # Default: 0.35
